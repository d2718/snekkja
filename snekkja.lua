...
#flexcol { height: 100vh; display: flex; flex-direction: column;
...
#main figure { margin: 0; max-height: 100%; margin-left: 1em; margin-right: 1em; }
#main figure img { max-height: 100%; max-width: 100%; }
